...
public class LegacyTest {
    ...
    private final Set<Material> INVALIDATED_MATERIALS = new HashSet<>(Arrays.asList(Material.ACACIA_BUTTON, Material.ACACIA_PRESSURE_PLATE, Material.ACACIA_TRAPDOOR, Material.AIR, Material.ATTACHED_MELON_STEM, Material.ATTACHED_PUMPKIN_STEM,
            ...
            // 1.22
            Material.BLACK_HARNESS, Material.BLUE_HARNESS, Material.BROWN_HARNESS, Material.CYAN_HARNESS, Material.DRIED_GHAST, Material.GRAY_HARNESS, Material.GREEN_CONCRETE_POWDER, Material.GREEN_HARNESS, Material.HAPPY_GHAST_SPAWN_EGG, Material.LEGACY_BLACK_GLAZED_TERRACOTTA, Material.LIGHT_BLUE_HARNESS, Material.LIGHT_GRAY_HARNESS, Material.LIME_HARNESS, Material.MAGENTA_HARNESS, Material.ORANGE_HARNESS, Material.PINK_HARNESS, Material.PURPLE_HARNESS, Material.RED_HARNESS, Material.WHITE_HARNESS, Material.YELLOW_HARNESS,
            //
